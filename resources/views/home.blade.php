                     ...
                     <table class="table table-hover">
                         ...
                         @foreach($contacts as $contact)
                             <tr>
                              ...
                              <div class="modal fade" id="addToFavoriteModal{{ $contact->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalCenterTitle">Add to Favorites</h5>
